...
MEALS = %w[lunch dinner].freeze
DISH_KEYS = %w[name needed priority remains].freeze
...
MAIN_COURSES_SOURCE = 'resources/main_courses.yml'
DESSERTS_SOURCE = 'resources/desserts.yml'
